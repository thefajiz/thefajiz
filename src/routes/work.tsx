  ...
  return (
    <Layout>
      ...
      <section className="px-6 md:px-12 pb-24 max-w-6xl mx-auto grid md:grid-cols-2 gap-8">
        {projects.map((p) => (
          ...
          >
            ...
            <a 
              href={`/${p.name.split(' ')[0]}.html`}
              className="text-gold border-b border-gold/50 hover:border-gold hover:text-gold-bright pb-1 text-xs tracking-widest-x inline-block mt-auto transition-all duration-300 transform hover:translate-x-2"
            >
              view project →
            </a>
          </article>
      ...
      <section className="px-6 md:px-12 pb-32 max-w-6xl mx-auto">
        <a
          href="https://drive.google.com/file/d/1A4uyg9R0Svu_cSCjjpAfcYEeVmQpTkq2/view?usp=drive_link"
          target="_blank"
          rel="noreferrer"
        ...
        >
          ...
          <div className="flex flex-col justify-center">
            <p className="text-[10px] tracking-widest-x text-muted">a short story by thefajiz</p>
            ...
            <span className="mt-6 text-xs tracking-widest-x text-gold group-hover:opacity-70 transition-opacity inline-block">
              read on drive
            </span>
          </div>
        </a>
